...
{
	public static List<MachinePath> BuildPaths(IxMilia.Dxf.DxfFile dxf) => BuildPaths(GetPaths(dxf));

	public static List<MachinePath> BuildPaths(Svg.SvgDocument svg) => BuildPaths(GetPaths(svg));
